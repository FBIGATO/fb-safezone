Citizen.CreateThread(function()
    ...
    PerformHttpRequest('https://raw.githubusercontent.com/FBIGATO/fb_AssetsVersions/master/'..resourceName..'.txt',function(error, result, headers)
        if not result then 
